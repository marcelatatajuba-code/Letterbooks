...
| **Capacidade de detecção** | defeito existe desde que foi escrito; o que muda é quando alguém consegue vê-lo. **18 dos 27** defeitos da última fase foram injetados antes dela e ficaram latentes de 1h20 a 23h. |
...
| defeitos registrados | 10 | 13 | 27 |
| **achados pela usuária** | **3 de 10** | **4 de 13** | **0 de 27** |
...
**2. "Defeitos por fase" mede DETECÇÃO, não injeção.** **18 dos 27**
defeitos da última fase nasceram antes dela e ficaram latentes de 1h20 a 23h —
...
Hoje: **323 asserções** em quatro suítes, mais **46 checagens** em 12 casos de
...
**18 de 50 defeitos** tem caso de regressão que os prende. Os outros 32 estão
...
| arquivo | o que é |
|---|---|
| `defeitos.csv` | os 50 defeitos, com fase, gravidade, **quem detectou** e latência |
