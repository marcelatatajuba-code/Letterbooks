...
| **Capacidade de detecção** | defeito existe desde que foi escrito; o que muda é quando alguém consegue vê-lo. **30 dos 97** defeitos da última fase foram injetados antes dela e ficaram latentes de 1h20 a 25h. |
...
| **achados pela usuária** | **3 de 10** | **4 de 13** | **4 de 97** |
...
**2. "Defeitos por fase" mede DETECÇÃO, não injeção.** **30 dos 97**
...
Hoje: **523 asserções** em quatro suítes, mais as checagens dos casos de
regressão, o rastreador (que não assere: mede e relata) e nove provas em
Postgres. Razão de verificação por app: razão de 0,62.

**23 de 120 defeitos** tem caso de regressão que os prende. Os outros 97 estão
...
| arquivo | o que é |
|---|---|
| `defeitos.csv` | os 120 defeitos, com fase, gravidade, **quem detectou** e latência |
