...
SO_DE_TELA = {
    ...
    'D94': 'mapa snake→camel duplicado — travado em testar_social ("chegou\n            COMPLETO no aparelho, com sinopse e ids de autoria")',
    'D104': 'ordem de blocos na página — medida em pixel pelo design',
    'D105': 'estado de carregando — travado em testar_social ("nenhum cartão diz\n            Livro")',
    'D106': 'CSS e semântica de contador — não alcançável por forma de dado',
    'D107': 'marcação morta escondida por CSS — idem',
    'D108': 'ritmo visual entre seções — CSS, medido pelo design',
    'D95': 'estrutura de DOM — travado em testar_social ("nenhum cartão da\n            estante alheia carimba selo meu")',
    'D96': 'estouro síncrono sem sessão — não alcançável por forma de dado',
    'D97': 'contagem de requisições — não é forma de dado',
    'D98': 'defeito de uma asserção, não do app',
    'D99': 'ausência de CSS numa entrega — processo, não código do app',
    'D100': 'CSS morto por cascata — não alcançável por dado; medido pelo design',
    'D101': 'rota sem saída — estrutura de tela; item de backlog',
    'D102': 'fluxo de folha — travado em testar_social ("desistir no fundo\n            escuro NÃO cria a lista")',
    'D103': 'posição em CSS por cascata — não alcançável por dado',
