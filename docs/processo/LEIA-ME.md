...
| **Capacidade de detecção** | defeito existe desde que foi escrito; o que muda é quando alguém consegue vê-lo. **30 dos 96** defeitos da última fase foram injetados antes dela e ficaram latentes de 1h20 a 25h. |
...
| **achados pela usuária** | **3 de 10** | **4 de 13** | **4 de 96** |
...
**2. "Defeitos por fase" mede DETECÇÃO, não injeção.** **30 dos 96**
...
Hoje: **505 asserções** em quatro suítes, mais as checagens dos casos de
regressão, o rastreador (que não assere: mede e relata) e nove provas em
Postgres. Razão de verificação por app: razão de 0,62.

**23 de 119 defeitos** tem caso de regressão que os prende. Os outros 96 estão
...
| arquivo | o que é |
|---|---|
| `defeitos.csv` | os 119 defeitos, com fase, gravidade, **quem detectou** e latência |
